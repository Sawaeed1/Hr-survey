<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" EnableEventValidation="false" Inherits="web._default" %>
    ...
    <form id="frm" runat="server">
                                        ...
                                        <asp:Panel ID="pnlregister" Visible="true" runat="server">
                                            ...
                                            <form class="user">
                                                ...
                                                <asp:Panel ID="pnlEmployment" runat="server">
                                                    ...
                                                    <div class="form-group" dir="rtl">
                                                        <asp:Label ID="Label4" ForeColor="Black" runat="server" Style="direction: rtl" Text="اختر منطقة"></asp:Label>
                                                        <b style="color: red">*</b><br />
                                                    ...
                                                    <div class="question">
                                                        <div class="form-group" dir="rtl">
                                                            ...
                                                            <asp:Label ID="Label10" Text="ما مدى رضاك عن جودة المرشحين الذين يقدمهم فريق التوظيف؟ " ForeColor="Black" runat="server" Style="direction: rtl"></asp:Label>
                                                            <b style="color: red">*</b><br />
                                                    ...
                                                    <div class="question">
                                                        <div class="form-group" dir="rtl">
                                                            ...
                                                            <asp:Label ID="Label1" Text="ما مدى كفاءة وفعالية عملية التوظيف من نشر الوظيفة إلى اختيار المرشح؟ " ForeColor="Black" runat="server" Style="direction: rtl"></asp:Label>
                                                            <b style="color: red">*</b><br />
                                                    ...
                                                    <div class="question">
                                                        <div class="form-group" dir="rtl">
                                                            ...
                                                            <asp:Label ID="Label2" Text="ما مدى فهم فريق التوظيف وملاءمته لاحتياجات التوظيف الخاصة بقسمك؟ " ForeColor="Black" runat="server" Style="direction: rtl"></asp:Label>
                                                            <b style="color: red">*</b><br />
                                                    ...
                                                    <div class="question">
                                                        <div class="form-group" dir="rtl">
                                                            ...
                                                            <asp:Label ID="Label3" Text="ما مدى فعالية التعاون بين قسمك وفريق التوظيف؟" ForeColor="Black" runat="server" Style="direction: rtl"></asp:Label>
                                                            <b style="color: red">*</b><br />
                                                    ...
                                                    <div class="question">
                                                        <div class="form-group" dir="rtl">
                                                            ...
                                                            <asp:Label ID="Label5" Text="ما مدى فعالية عملية تهيئة الموظفين في مساعدتك على الاندماج في ثقافة الشركة؟ " ForeColor="Black" runat="server" Style="direction: rtl"></asp:Label>
                                                            <b style="color: red">*</b><br />
                                                    ...
                                                    <div class="question">
                                                        <div class="form-group" dir="rtl">
                                                            <asp:Image ID="Image6" runat="server" ImageUrl="~/Resources/img/question.png" Width="30px" Height="28px" />
                                                            <asp:Label ID="Label6" Text="ما مدى استعدادك لدورك ومسؤولياتك بفضل عملية تهيئة الموظفين ؟ " ForeColor="Black" runat="server" Style="direction: rtl"></asp:Label>
                                                            <b style="color: red">*</b><br />
                                                            ...
                                                            <div style="direction: rtl">
                                                                ...
                                                                <div style="display: none">
                                                                    <asp:Label ID="selectedRating6" runat="server"></asp:Label>
                                                                </div>
                                                                <asp:HiddenField ID="hiddenSelectedRating6" runat="server" />
                                                      ...
                                                      <div class="question">
                                                        <div class="form-group" dir="rtl">
                                                            <asp:Image ID="Image7" runat="server" ImageUrl="~/Resources/img/question.png" Width="30px" Height="28px" />
                                                            <asp:Label ID="Label7" Text="ما مدى رضاك عن الدعم والموارد المقدمة خلال فترة تهيئتك ؟ " ForeColor="Black" runat="server" Style="direction: rtl"></asp:Label>
                                                            <b style="color: red">*</b><br />
                                                            ...
                                                            <div style="direction: rtl">
                                                                ...
                                                                <div style="display: none">
                                                                    <asp:Label ID="selectedRating7" runat="server"></asp:Label>
                                                                </div>
                                                                <asp:HiddenField ID="hiddenSelectedRating7" runat="server" />
                                                     ...
                                                     <div class="question">
                                                        <div class="form-group" dir="rtl">
                                                            <asp:Image ID="Image8" runat="server" ImageUrl="~/Resources/img/question.png" Width="30px" Height="28px" />
                                                            <asp:Label ID="Label8" Text="ما مدى وضوح شرح سياسات وإجراءات الشركة خلال فترة تهيئتك؟ " ForeColor="Black" runat="server" Style="direction: rtl"></asp:Label>
                                                            <b style="color: red">*</b><br />
                                                            ...
                                                            <div style="direction: rtl">
                                                                ...
                                                                <div style="display: none">
                                                                    <asp:Label ID="selectedRating8" runat="server"></asp:Label>
                                                                </div>
                                                                <asp:HiddenField ID="hiddenSelectedRating8" runat="server" />
        ...
        <script>
            ...
            function validate() {
                ...
                var txt6 = document.getElementById('<%= hiddenSelectedRating6.ClientID %>');
                var txt7 = document.getElementById('<%= hiddenSelectedRating7.ClientID %>');
                var txt8 = document.getElementById('<%= hiddenSelectedRating8.ClientID %>');


                if (txt1.value == "") {
                    displayErrorMessage("ما مدى رضاك عن جودة المرشحين الذين يقدمهم فريق التوظيف؟");
                    isValid = false;
                }
                ...
                if (txt2.value == "") {
                    displayErrorMessage("ما مدى كفاءة وفعالية عملية التوظيف من نشر الوظيفة إلى اختيار المرشح؟");
                    isValid = false;
                }
                ...
                if (txt3.value == "") {
                    displayErrorMessage("ما مدى فهم فريق التوظيف وملاءمته لاحتياجات التوظيف الخاصة بقسمك؟");
                    isValid = false;
                }


                if (txt4.value == "") {
                    displayErrorMessage("ما مدى فعالية التعاون بين قسمك وفريق التوظيف؟");
                    isValid = false;
                }
